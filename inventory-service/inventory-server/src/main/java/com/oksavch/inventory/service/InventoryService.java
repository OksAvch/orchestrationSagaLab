package com.oksavch.inventory.service;
...
public class InventoryService {
    ...
    public QtyResponseDTO getInventory(int productId) {
        return new QtyResponseDTO(Optional.ofNullable(productInventoryMap.get(productId)).orElse(0));
    }
}
